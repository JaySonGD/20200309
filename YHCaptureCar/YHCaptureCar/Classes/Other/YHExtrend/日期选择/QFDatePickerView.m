...
@interface QFDatePickerView () <UIPickerViewDataSource,UIPickerViewDelegate>{
    ...
    NSMutableArray *monthArray;   //月数组
    NSInteger currentYear;        //当前年份
    NSInteger currentMonth;       //当前月份
    NSString *restr;
    
    NSString *selectedYear;       //选择年份
    NSString *selectecMonth;      //选择月份
    
    BOOL onlySelectYear;          //只选择年份
}
...
//    [yearArray addObject:@"至今"];
    NSString *nextYear = [NSString stringWithFormat:@"%ld年",currentYear+1];
