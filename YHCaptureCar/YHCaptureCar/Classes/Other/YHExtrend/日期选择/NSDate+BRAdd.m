...
+ (NSString *)date:(NSString *)dateString formatter:(NSString *)formatterStr addDays:(CGFloat)days {
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc]init];
...
+(NSString *)getPriousorLaterDateFromDate:(NSDate *)date
    ...
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc]init];
    dateFormatter.dateFormat = formatterStr; //yyyy-MM-dd
    NSString *newDateString = [dateFormatter stringFromDate:mDate];
    return newDateString;
