...
- (MYColorBackView *)colorBackView
{
    if (!_colorBackView) {
        ...
        if (self.isNeedClearBack) {
            _colorBackView.backColorView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.1];
        }else{
            _colorBackView.backColorView.backgroundColor = [UIColor clearColor];
//            if (_showFrame.origin.y > 64) {
//                _colorBackView.topView.backgroundColor   = [UIColor redColor];
//            }
//            //全屏蒙版
//            _colorBackView.topView.backgroundColor   = [UIColor blueColor];
        }
