...
@interface YHAuctionContentController ()
...
@implementation YHAuctionContentController
...
- (void)scrollViewDidEndScroll {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"kUpDataList" object:nil userInfo:@{@"tag" : @(1)}];
...
- (void)setUI{
    ...
    [leftBtn setTitle:@"正在竞价" forState:UIControlStateNormal];
    ...
    [rightBtn setTitle:@"竞价记录" forState:UIControlStateNormal];
    ...
    YHAuctionViewController *vc1 = [YHAuctionViewController new];
    vc1.isInAuction = YES;
    UIView *view1 = vc1.view;
    [contentView addSubview:view1];
    [self addChildViewController:vc1];
    
    YHAuctionViewController *vc2 = [YHAuctionViewController new];
    vc2.isInAuction = NO;
