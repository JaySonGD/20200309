...
+(void)erpAuthDetailWithCarId:(NSString *)carId
    ...
    [YHNetworkManager.sharedYHNetworkManager YHBasePOST:ApiService.sharedApiService.detailURL
                                                  param:parameters
                                             onComplete:^(NSDictionary *info) {
                                                 ...
                                                 !(success)? : success([YTCarModel mj_objectWithKeyValues:info[@"result"]]);
                                             }
                                                onError:^(NSError *error) {
                                                    !(failure)? : failure(error);
                                                }];
...
+(void)helpBuyAuthDetailWithCarId:(NSString *)carId
    ...
    NSDictionary *parameters = @{@"reqAct" : @"helpBuyCarInfo",
                                 @"token" : token,
                                 @"carId"  : carId
                                 };
    
    [YHNetworkManager.sharedYHNetworkManager YHBasePOST:ApiService.sharedApiService.helpBuyDetailURL
                                                  param:parameters
                                             onComplete:^(NSDictionary *info) {
...
+(void)toHelpBuyCarPayWithId:(NSString *)workOrderId
    ...
    NSDictionary *parameters = @{@"reqAct" : @"toHelpBuyCarPay",
                                 @"token" : token,
    ...
    [YHNetworkManager.sharedYHNetworkManager YHBasePOST:ApiService.sharedApiService.helpBuyDetailURL
                                             ...
                                             onComplete:^(NSDictionary *info) {
                                                 ...
                                                 if (payStatus == 1) {
                                                     !(success)? : success([info valueForKey:@"result"],nil);
                                                 }else{
                                                     !(success)? : success(nil,info);
                                                 }
