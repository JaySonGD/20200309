...
- (void)updateTableAndFrame {
    // 重新布局tableview
    self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y, _size.width, CCZROW_HEIGHT * self.itemsArr.count);
    self.mainTableView.frame = CGRectMake(0, 0, _size.width, CCZROW_HEIGHT * self.itemsArr.count);
