...
- (void)viewDidLoad {
  ...
  NSArray *nibObjects =
      [[NSBundle mainBundle] loadNibNamed:@"UnifiedNativeAdView" owner:nil options:nil];//UnifiedNativeAdView
...
//    GADMultipleAdsAdLoaderOptions;
    ...
    mediaAdOptions.mediaAspectRatio = GADMediaAspectRatioPortrait;// GADMediaAspectRatioPortrait;//GADMediaAspectRatioSquare;//GADMediaAspectRatioLandscape;
//
...
//    adViewOptions.preferredAdChoicesPosition = GADAdChoicesPositionBottomRightCorner;
  ...
  self.adLoader = [[GADAdLoader alloc] initWithAdUnitID:TestAdUnit
                                     rootViewController:self
                                                ...
                                                options:@[ videoOptions ,mediaAdOptions]];
