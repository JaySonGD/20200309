...
#number=2
#echo "Place enter the number you want to export ?\n\r [ 1:production(Debug) 2:dev(Debug) 3:test(Debug) 4:location(Debug) 5:appStore(Release) ] "
echo "Place enter the number you want to export ?"

echo "|----------------------------------------------------------------------------------------------|"
echo "|                 |                |                 |                |                        |"
echo "|   1:pro(Debug)  |  2:dev(Debug)  |  3:test(Debug)  |  4:loc(Debug)  |  5:appStore(Release)   |"
echo "|                 |                |                 |                |                        |"
echo "|----------------------------------------------------------------------------------------------|"
...
#echo "Place enter the number you want to export ? [ 1:production(Debug) 2:dev(Debug) 3:test(Debug) 4:location(Debug) 5:appStore(Release) ] "
echo "Place enter the number you want to export ?"
