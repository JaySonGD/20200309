...
- (void)YH_showStartLoadStatus{
    ...
    CGFloat loginInfoWidth = [self.YH_loadStatusTitle boundingRectWithSize:CGSizeMake(MAXFLOAT, 16.0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16.0]} context:nil].size.width;
    ...
    [self addConstraints:@[
                           ...
                           [NSLayoutConstraint
                            ...
                            multiplier:1.0
                            constant:-(loginInfoWidth/2.0 + 10)],
                           ]];
