...
@interface TTZPlateKeyBoardView()
{
    UIView *_backView1;
    UIView *_backView2;
    UIView *_bottomView;
...
@implementation TTZPlateKeyBoardView
...
- (void)setFrame:(CGRect)frame{
    [super setFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width,kScreenHeight * 0.33)];
}

- (void)setupUI {
    
    CGSize size = self.bounds.size;//[UIScreen mainScreen].bounds.size;
    _backView1 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, size.width, size.height * 1 - kSafeBottomHeight)];
    _backView1.backgroundColor = HEXCOLOR(0xd2d5da, 1);
    _backView1.hidden = NO;
    
    _backView2 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, size.width, size.height * 1 - kSafeBottomHeight)];
    _backView2.hidden = YES;
    _backView2.backgroundColor = HEXCOLOR(0xd2d5da, 1);
   
    self.backgroundColor = HEXCOLOR(0xd2d5da, 1);
...
//        frame.origin.y = size.height - size.height * 1;
