...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        gtlCalendarHeaderReusableView.backgroundColor = [UIColor colorWithRed:242/255.0 green:242/255.0 blue:242/255.0 alpha:1.0];
...
- (void)setupCollectionViews {
    ...
    if (([fromDate compare:[NSDate date]] == NSOrderedAscending)
        &&  ([toDate compare:[NSDate date]] == NSOrderedDescending)) {
        NSInteger months = [NSCalendar monthsFromDate:fromDate toDate:[NSDate date]];
        indexPath = [NSIndexPath indexPathForRow:0 inSection:months - 2];
    }
