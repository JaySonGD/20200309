...
- (void)setCodes:(NSArray *)codes{
    ...
    [codes enumerateObjectsUsingBlock:^(NSDictionary * obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        //[btn setImage:[UIImage imageNamed:[obj valueForKey:@"code"]] forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage imageNamed:[obj valueForKey:@"code"]] forState:UIControlStateNormal];
