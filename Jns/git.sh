#使用方法
GIT_LOG=`git log -5 --pretty=format:"%s"`
#$GIT_LOG
#echo "http://127.0.0.1/app/public/api/appSumbit?debug=99&log=$GIT_LOG&json"
...
#$GIT_LOG
curl -i "http://http://192.168.1.22/app/public/api/te?debug=99&json" -X POST -d "log=$GIT_LOG"
