...
+ (instancetype)viewWithKey:(NSString *)key{
    ...
    NSDictionary *obj = @{@"cell":@0,@"figureHead":@1,@"posture":@2,@"postureHead":@3};
    NSInteger index = [obj[key] integerValue];

    return [[NSBundle mainBundle] loadNibNamed:@"PCCarouselCell" owner:nil options:nil][index];
}
...
- (void)setItem:(YHCellItem *)item{
    ...
    [carrt addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14] range:[cstr rangeOfString:@"cm"]];
    [carrt addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14] range:[cstr rangeOfString:@"减少"]];
    [carrt addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14] range:[cstr rangeOfString:@"增加"]];
