...
-(void)insertReadValues:(CBCharacteristic *)characteristics{
    ...
    NSString *stringFromData = [[NSString alloc] initWithData:characteristics.value encoding:NSUTF8StringEncoding];
    [self->readValueArray addObject:stringFromData];
...
//    [self.characteristic peripheralIsReadyToSendWriteWithoutRespo  ]
//    int i = 1;
    Byte b = 0X01;
