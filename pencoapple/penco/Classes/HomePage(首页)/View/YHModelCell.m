...
- (void)postureLoad:(PCPostureCard *)item{
    ...
    self.valueLB.text = [NSString stringWithFormat:@"%.1f", [YHTools roundNumberStringWithRound:2 number:item.value.floatValue]];
