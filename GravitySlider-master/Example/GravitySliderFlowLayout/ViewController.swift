...
class ViewController: UIViewController {
    ...
    let collectionViewCellHeightCoefficient: CGFloat = 1.0//0.85
    let collectionViewCellWidthCoefficient: CGFloat = 0.25//0.55
...
//        let gravitySliderLayout = GravitySliderFlowLayout(with: CGSize(width: collectionView.frame.size.width * collectionViewCellWidthCoefficient, height: collectionView.frame.size.height * collectionViewCellHeightCoefficient))
        let gravitySliderLayout = GravitySliderFlowLayout(with: CGSize(width: collectionView.frame.size.width *  collectionViewCellHeightCoefficient, height: collectionView.frame.size.height * collectionViewCellWidthCoefficient))
...
//        cell.productImage.image = images[indexPath.row % images.count]
        ...
        cell.newLabel.text = "\(indexPath.item)"
    }
