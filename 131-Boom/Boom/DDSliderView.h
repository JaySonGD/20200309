...
@protocol DDSliderViewDelegate <NSObject>
...
@interface DDSliderButton : UIButton

@end

@interface DDSliderView : UIView

@property (nonatomic, weak) id<DDSliderViewDelegate> delegate;

/** 滑块 */
@property (nonatomic, strong, readonly) DDSliderButton *sliderBtn;
